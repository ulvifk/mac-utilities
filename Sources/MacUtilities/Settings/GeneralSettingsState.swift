...
/// What the General tab shows besides the feature switches: the Accessibility grant and the login item, both granted outside the app and so re-read on demand.
